...
int main()
{
  ...
  auto tree = factory.createTreeFromFile("./10_tree.xml");

  // Helper function to print the tree
  BT::printTreeRecursively(tree.rootNode());

  // The purpose of the observer is to save some statistics about the number of time a certain node
  // returns SUCCESS or FAILURE. This is particularly useful to create unit tests and to check if a
  // certain set of transitions happened as expected
  ...
  // You can access a specific statistic, using its full path or the UID
